    ...
    _createClass(TributeRange, [{
        ...
        if (typeof info !== 'undefined') {
          ...
          if (!this.isContentEditable(context.element)) {
			...
			if (typeof CKEDITOR !== "undefined" &&
				...
				var local = $.map(CKEDITOR.instances, function(i, k) { return k })[0];

				if (typeof CKEDITOR.instances[local] !== "object") {
					this.tribute.menu.style.cssText = "top: ".concat(coordinates.top, "px;\n                                     left: ").concat(coordinates.left, "px;\n                                     right: ").concat(coordinates.right, "px;\n                                     bottom: ").concat(coordinates.bottom, "px;\n                                     position: absolute;\n                                     display: block;");
				}
				if (CKEDITOR.instances[local].mode == "wysiwyg") {
					var ckcoordinates = CKEDITOR.instances[local].container.$.parentElement.getBoundingClientRect(),
					cktop = CKEDITOR.instances[local].container.$.childNodes[0].childNodes[0].offsetHeight,
					ftop = coordinates.top + ckcoordinates.top + cktop,
					fleft = coordinates.left + ckcoordinates.left;
					this.tribute.menu.style.cssText = "top: ".concat(ftop, "px;\n                                     left: ").concat(fleft, "px;\n                                     right: ").concat(coordinates.right, "px;\n                                     bottom: ").concat(coordinates.bottom, "px;\n                                     position: absolute;\n                                     display: block;");
				}
				else {
					this.tribute.menu.style.cssText = "top: ".concat(coordinates.top, "px;\n                                     left: ").concat(coordinates.left, "px;\n                                     right: ").concat(coordinates.right, "px;\n                                     bottom: ").concat(coordinates.bottom, "px;\n                                     position: absolute;\n                                     display: block;");
				}
      ...
      value: function getWindowSelection() {
		...
		if (typeof CKEDITOR !== "undefined" &&
			typeof CKEDITOR.instances !== "undefined") {
			var local;
			local = $.map(CKEDITOR.instances, function(i, k) { return k })[0];

			if (typeof CKEDITOR.instances[local] !== "object") {
				return window.getSelection();
			}
				return CKEDITOR.instances[local].getSelection().getNative();
		}
